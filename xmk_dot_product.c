...
u32 XMk_dot_product_Write_MatrixB0_Words(XMk_dot_product *InstancePtr, int offset, word_type *data, int length) {
    ...
    for (i = 0; i+3 < length; i += 4) {
        int32x4_t src = vld1q_s32((int*)(data+i));
        vst1q_s32((int*)(InstancePtr->Control_BaseAddress + XMK_DOT_PRODUCT_CONTROL_ADDR_MATRIXB0_BASE + (offset + i)*4), src);
    }
    for (; i < length; i++) {
...
u32 XMk_dot_product_Write_MatrixB2_Words(XMk_dot_product *InstancePtr, int offset, word_type *data, int length) {
    ...
    for (i = 0; i+3 < length; i += 4) {
        int32x4_t src = vld1q_s32((int*)(data+i));
        vst1q_s32((int*)(InstancePtr->Control_BaseAddress + XMK_DOT_PRODUCT_CONTROL_ADDR_MATRIXB2_BASE + (offset + i)*4), src);
    }
    for (; i < length; i++) {
...
u32 XMk_dot_product_Write_MatrixB3_Words(XMk_dot_product *InstancePtr, int offset, word_type *data, int length) {
    ...
    for (i = 0; i+3 < length; i += 4) {
        int32x4_t src = vld1q_s32((int*)(data+i));
        vst1q_s32((int*)(InstancePtr->Control_BaseAddress + XMK_DOT_PRODUCT_CONTROL_ADDR_MATRIXB3_BASE + (offset + i)*4), src);
    }
    for (; i < length; i++) {
...
u32 XMk_dot_product_Write_MatrixB4_Words(XMk_dot_product *InstancePtr, int offset, word_type *data, int length) {
    ...
    for (i = 0; i+3 < length; i += 4) {
        int32x4_t src = vld1q_s32((int*)(data+i));
        vst1q_s32((int*)(InstancePtr->Control_BaseAddress + XMK_DOT_PRODUCT_CONTROL_ADDR_MATRIXB4_BASE + (offset + i)*4), src);
    }
    for (i; i < length; i++) {
...
u32 XMk_dot_product_Read_Output_r_Words(XMk_dot_product *InstancePtr, int offset, word_type *data, int length) {
    ...
    for (i=0; i+3 < length; i += 4) {
      int32x4_t src = vld1q_s32((int *)(InstancePtr->Control_BaseAddress + XMK_DOT_PRODUCT_CONTROL_ADDR_OUTPUT_R_BASE + (offset + i)*4));
      vst1q_s32(data+i, src);
    }
    for (i; i < length; i++) {
